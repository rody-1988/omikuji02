...
const LUCKY_MAP = {
  ...
  オレンジ: "#ffa500",
  コーラルレッド: "#ff7f50",
  ターコイズブルー: "#00ced1", // 鮮やかな海の青
  サンセットオレンジ: "#ff8c00", // 夕暮れの輝き
  ムーンライトシルバー: "#c0c0c0", // 月の光
  ラピスラズリ: "#000080", // 聖なる石の紺
  リーフミント: "#98fb98", // 若葉のエネルギー
  コーラルピンク: "#ff7f50", // 珊瑚の温もり
  アメジスト紫: "#9932cc", // 直感の紫
  サンドベージュ: "#f5f5dc", // 砂浜の落ち着き
  オーシャンナイト: "#191970", // 深い夜の海
  サニーイエロー: "#ffff00", // はじける太陽
